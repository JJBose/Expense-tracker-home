...
import "./Home.css";
import loglogo from "./app-logo.png";
import adv_1 from "./adv-1.JPG";
import adv_2 from "./adv-2.JPG";
import adv_3 from "./adv-3.JPG";
  ...
  return (
    <div style={{ height: "100%", overflowY: "scroll" }}>
      ...
      <div className="home-nav" id="top">
        <img src={loglogo} alt=" " className="app-logo" />
      ...
      <div className="review-header">
        ...
        <img src="https://moneylover.me/img/Stars.svg" alt=" " className="stars" />
      </div>
